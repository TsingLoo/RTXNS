...
// Input: NdotL, NdotV, NdotH, VdotL, roughness, metallic, specular, thick, ao, curv, wrap, trans, fwd_scatter, thin_backlight, fresnel, baseR, baseG, baseB = 18
#define UNIFIED_INPUT_FEATURES 18
#define UNIFIED_INPUT_NEURONS 18
